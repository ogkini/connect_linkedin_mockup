...
export class SignUpComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.signUpForm = this.formBuilder.group({
      firstname: ['', Validators.compose([Validators.required, TextValidatorDirective.validateCharacters,
          Validators.minLength(2), Validators.maxLength(45)])],
      lastname: ['', Validators.compose([Validators.required, TextValidatorDirective.validateCharacters,
          Validators.minLength(2), Validators.maxLength(45)])],
      ...
      confirmPassword: ['', Validators.compose([Validators.required,
          PasswordConfirmValidatorDirective.validatePasswordConfirmation, Validators.minLength(6),
